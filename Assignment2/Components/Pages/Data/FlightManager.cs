        ...
        */
        ...
        public static List<Flight> findFlights(string from, string to, string weekday)
        {
           ...
           // ...................................
            ...
            foreach (Flight flight in flights)
            {
                if ((flight.From.Equals(from) || string.IsNullOrEmpty(from)) && (flight.To.Equals(to) || string.IsNullOrEmpty(to)) && (flight.Weekday.Equals(weekday) || weekday.Equals(WEEKDAY_ANY))) 
                {
                    found.Add(flight);
                }
